...
lightgbm_config = {
    ...
    'model_params': {
      'boosting_type': 'gbdt',
      'learning_rate': 0.13722115025337295,
      'max_bin': 255,
      'max_depth': 15,
      'metric': 'rmse',
      'min_data': 1000,
      'min_data_in_bin': 500,
      'min_hessian': 1.3338565405808374,
      'num_boost_round': 588,
      'num_leaves': 150,
      'objective': 'regression',
      'sub_feature': 0.08550035045765396,
      'top_k': 100,
      'verbose': -1},
    # 'features': lightgbm_config_feature_list,
    # 'image_feature_folders': ['image_features/ads_image_features'],
    ...
    'tune_params': {
        'param_space': {
            ...
            'model_params': {
                ...
                # 'top_k':  hp.choice('top_k', [50,100, 150]),
                # 'max_bin': hp.choice('max_bin', [255, 500, 750]),
                # 'min_data_in_bin': hp.choice('min_data_in_bin', [100, 300, 500]),
                ...
                # 'metric': 'rmse',
                # 'num_leaves': hp.choice('num_leaves', [30, 60, 150]),
                # 'min_data': hp.choice('min_data', [500, 750, 1000]),
                # 'num_boost_round': 1000,
